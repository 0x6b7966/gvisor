...
type LinkEndpoint interface {
	...
	// route. It sets pkt.LinkHeader if a link layer header exists.
	// pkt.NetworkHeader and pkt.TransportHeader must haev already been
	// set.
	//
	...
	WriteRawPacket(pkt tcpip.PacketBuffer) *tcpip.Error
